...
import com.plcoding.composepaging3caching.network.BeerRemoteMediator
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideBeerPager(beerDb: BeerDatabase, beerApi:ApiService): Pager<Int, BeerEntity> {
        return Pager(
